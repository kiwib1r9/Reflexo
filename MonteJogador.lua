...
local copas = love.graphics.newImage('img/copas-small.jpg')
local paus = love.graphics.newImage('img/paus-small.jpg')
local espadas = love.graphics.newImage('img/espadas-small.jpg')
local diamante = love.graphics.newImage('img/diamante-small.jpg')


function MonteJogador:init(x,y, numero)
    self.x = x
    self.y = y
    self.numero = numero
